...
CREATE TABLE IF NOT EXISTS portfolio_projects( --changed
...
CREATE TABLE IF NOT EXISTS portfolio_project_images( -- changed added
...
CREATE TABLE IF NOT EXISTS project_proposal_images( --changed all
    image_id SERIAL PRIMARY KEY,
    attachment BYTEA,
    encoding VARCHAR(255),
    mime_type VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS accepted_project_images( --changed added
    image_id SERIAL PRIMARY KEY,
    attachment BYTEA,
    encoding VARCHAR(255),
    mime_type VARCHAR(255),
